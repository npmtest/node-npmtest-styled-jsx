...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-styled-jsx/node_modules/styled-jsx/dist/style.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header low">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-styled-jsx/node_modules/styled-jsx/dist/style.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-styled-jsx/node_modules/styled-jsx/dist/</a> &#187; style.js</div>
</div>
<div class="body">
...
&nbsp;
var update = typeof window === 'undefined' ? doRender : <span class="branch-1 cbranch-no" title="branch not covered" >updateOnClient;</span>
var components = [];
...
var isSafari = typeof window === 'undefined' ? false : <span class="branch-1 cbranch-no" title="branch not covered" >/Version\/[0-9._]+.*Safari/.test(window.navigator.userAgent);</span>
&nbsp;
...
<span class="cstat-no" title="statement not covered" >      mount(this);</span>
    }
  }, {
...
<span class="cstat-no" title="statement not covered" >      unmount(this);</span>
    }
  }, {
    key: 'render',
...
<span class="cstat-no" title="statement not covered" >      var props = _step.value.props;</span>
&nbsp;
<span class="cstat-no" title="statement not covered" >      ret[props.styleId] = props.css;</span>
    }
  } catch (err) {
...
&nbsp;
<span class="fstat-no" title="function not covered" >function mount(component) {</span>
<span class="cstat-no" title="statement not covered" >  components.push(component);</span>
<span class="cstat-no" title="statement not covered" >  update();</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function unmount(component) {</span>
<span class="cstat-no" title="statement not covered" >  var i = components.indexOf(component);</span>
<span class="cstat-no" title="statement not covered" >  if (i &lt; 0) {</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
<span class="cstat-no" title="statement not covered" >  components.splice(i, 1);</span>
<span class="cstat-no" title="statement not covered" >  update();</span>
}
&nbsp;
<span class="fstat-no" title="function not covered" >function updateOnClient() {</span>
<span class="cstat-no" title="statement not covered" >  if (isSafari) {</span>
    // debouncing causes FOUC in Safari
<span class="cstat-no" title="statement not covered" >    doRender();</span>
<span class="cstat-no" title="statement not covered" >    return;</span>
  }
&nbsp;
...
<span class="cstat-no" title="statement not covered" >  var promise = updatePromise = Promise.resolve().then(<span class="fstat-no" title="function not covered" >function () {</span></span>
<span class="cstat-no" title="statement not covered" >    if (promise === updatePromise) {</span>
<span class="cstat-no" title="statement not covered" >      updatePromise = null;</span>
<span class="cstat-no" title="statement not covered" >      doRender();</span>
    }
  });
}
&nbsp;
<span class="fstat-no" title="function not covered" >function doRender() {</span>
<span class="cstat-no" title="statement not covered" >  (0, _render2.default)(components);</span>
}
&nbsp;</pre></td></tr>
</table></pre>
</div>
